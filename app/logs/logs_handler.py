...
class Action(str, Enum):
    ...
    DB_GET_CHAT_SHARE_USERS = auto()
    DB_GET_CHAT_SHARE_USER_MAPPING = auto()
    DB_ADD_CHAT_SHARE_USER = auto()
    DB_REMOVE_CHAT_SHARE_USER = auto()
    DB_SET_CHAT_SHARE_USER_NOTIFIED = auto()
