...
-- total lifetime sum of message.tokens (across all of that chat's
-- messages, any time, not just within the window).
...
--     that chat
--   * ranking uses SUM(message.tokens) over ALL messages in the chat, any
--     time, not just those within the window
--   * once a chat is selected, ALL of its messages are included (any time)
