...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "test_uploading_empty_csv_document",
            "tests/resources/empty.csv",
            400,
            {
                "error_code": "NO_TEXT_CONTENT_ERROR",
                "status": "failed",
                "status_message": "There is not usable text content in tests/resources/empty.csv file",
            },
        ),
        ("test_uploading_xlsx_document", "tests/resources/user_details.xlsx", 200, None),
        (
            "test_uploading_xls_document",
            "tests/resources/user_details.xls",
            400,
            {
                ...
                "status": "failed",
                "status_message": "Unsupported file format: .xls",
            },
        ),
